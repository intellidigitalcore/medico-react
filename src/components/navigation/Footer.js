          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-3 text-center sm:text-left">
              ...
              <ul className="space-y-4 lg:space-y-[18px]">
                <li><Link to="/" className="text-sm lg:text-base text-white/60 hover:text-primary">Home</Link></li>
                <li><Link to="/service" className="text-sm lg:text-base text-white/60 hover:text-primary">Services</Link></li>
                <li><Link to="/doctors" className="text-sm lg:text-base text-white/60 hover:text-primary">All Doctors</Link></li>
                <li><Link to="/blog" className="text-sm lg:text-base text-white/60 hover:text-primary">Blog</Link></li>
                <li><Link to="/appointment" className="text-sm lg:text-base text-white/60 hover:text-primary">Appointment</Link></li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-2 text-center sm:text-left">
              ...
              <ul className="space-y-4 lg:space-y-[18px]">
                <li><Link to="/service" className="text-sm lg:text-base text-white/60 hover:text-primary">Visit A Doctor</Link></li>
                <li><Link to="/service" className="text-sm lg:text-base text-white/60 hover:text-primary">Health Checkup</Link></li>
                <li><Link to="/service" className="text-sm lg:text-base text-white/60 hover:text-primary">Pharmacy</Link></li>
                <li><Link to="/service" className="text-sm lg:text-base text-white/60 hover:text-primary">Hospital</Link></li>
                <li><Link to="/service" className="text-sm lg:text-base text-white/60 hover:text-primary">Diagnostic</Link></li>
                <li><Link to="/service" className="text-sm lg:text-base text-white/60 hover:text-primary">Surgery</Link></li>
              </ul>
            </div>

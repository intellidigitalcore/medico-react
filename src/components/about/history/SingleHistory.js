...
const SingleHistory = ({data}) => {
  ...
  return (
    <div>
      ...
      <div className={`from-[${fromColor}] to-[${toColor}] h-[132px] w-[132px] lg:h-28 lg:w-28 rounded-2xl lg:rounded-full bg-gradient-to-b drop-shadow-[6.44211px_6.44211px_12.8842px_rgba(0,0,0,0.15)] flex items-center justify-center`}>

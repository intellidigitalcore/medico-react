      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 pt-10 md:pt-0">
        ...
        <div className="pl-4 pr-4 md:pr-0 2xl:pl-[120px] 3xl:pl-[305px]">
          ...
          <ul className="flex flex-col md:flex-row items-center gap-6 my-6 xl:my-8 2xl:my-10">
            <li><Link to="/appointment" className="inline-block box-border py-2 lg:py-3 px-9 md:px-8 lg:px-12 text-white text-sm font-semibold rounded-md bg-primary shadow-[0px_10px_10px_rgba(55,214,201,0.24)] hover:bg-primary-alt hover:shadow-none">Appointment</Link></li>
            <li><Link to="/doctors" className="inline-block box-border py-2 lg:py-3 px-9 md:px-8 lg:px-12 text-primary text-sm font-semibold rounded-md bg-white border border-primary">Find a Doctor</Link></li>
          </ul>

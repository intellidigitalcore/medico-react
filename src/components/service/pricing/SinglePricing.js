  ...
  return (
    <div className={`${status === 'active' ? 'active' : ''} pricing-card h-fit rounded-[10px] bg-white shadow-[0px_4px_20px_rgba(4,90,181,0.08)] p-6 hover:shadow hover:shadow-[rgba(4,90,181,0.08)] transition-all duration-300`}>
      ...
      <div className="text-center">
        <Link to="/" className="inline-block py-3 px-12 text-white text-sm font-semibold rounded-md bg-primary shadow-[0px_10px_10px_rgba(55,214,201,0.24)] hover:bg-primary-alt hover:shadow-none">Choose Plan</Link>
      </div>
    </div>
  )
}
